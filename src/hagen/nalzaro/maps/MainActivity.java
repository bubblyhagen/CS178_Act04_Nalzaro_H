...
public class MainActivity extends Activity implements OnMapClickListener
{
  ...
  static final LatLng home = new LatLng(10.0, 123.97639);
	  ...
	  setContentView(R.layout.activity_main);
	    ...
	    if(GooglePlayServicesUtil.isGooglePlayServicesAvailable(getApplicationContext()) == ConnectionResult.SUCCESS)
	    {
	    	...
	    	if(a != null)
	    	{
	    		...
	    		Marker usc_main = a.addMarker(new MarkerOptions().position(uscMain).title("USC-Downtown"));
	    		Marker my_place = a.addMarker(new MarkerOptions().position(home).title("My Place"));
